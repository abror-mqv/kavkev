        ...
        <MainContainer>
                ...
                <Box sx={style}>
                    ...
                    >
                        <span style={{ color: "red", fontSize: "22px" }}>
                            Ошибка регистрации! Возможно, на данный номер уже зарегистрирован аккаунт
                        </span>
                        <img
                            src={alert}
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <p id="num">
                    ...
                    <span>Пароль должен содержать цифры в том числе</span>
                </p>
                <p id="more8">
                    <FontAwesomeIcon className="fa-times icon" icon={faTimes} />
                    <FontAwesomeIcon className="fa-check icon" icon={faCheck} />
                    <span>Пароль должен состоять из 8 символов как минимум</span>
                </p>
